        ...
        <main>
          <div className="flex min-h-screen flex-col items-center p-12">
            ...
            <div className="w-full max-w-4xl p-12 bg-white rounded shadow-md">
              <p className="mb-6">
                Welcome to the J.B. Hunt Intern Ping Pong ELO site. Here, interns can play ping pong matches against
                each
              ...
              <ul className="list-disc list-inside mb-6">
                ...
                <li>
                  ...
                  actually 1200. Through your first 7 matches, you will be &quot;gaining&quot; these points back. This
                  system is
                ...
                <li>
                  Your rank is based on your ELO range. These ranks are based loosely on Codeforces and don&apos;t have
                  any
